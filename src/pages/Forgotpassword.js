      ...
      <div className="row">
        <div className="col-12">
          ...
          <h3 style={{ color: 'white', fontSize: '24px' }}>Reset Your Password</h3>
            ...
            <form action="mailto:recipient@example.com" method="get" enctype="text/plain" className='d-flex flex-column gap-15'>
              <div>
                <input 
                type="email" 
                name='email'
              ...
              <div>
                ...
                <button 
                  className="button border-0" type="Submit">Submit 
                </button>                
